...
include("C:/Users/shahr/github/AlphaShapes.jl/src/AlphaStructures.jl")

using LinearAlgebraicRepresentation, ViewerGL,TimerOutputs
...
function pointsRand(
    ...
    filename = "C:/Users/shahr/github/AlphaShapes.jl/examples/examples2D/svg_files/Lar2.svg";
    ...
    reduced_filter = [
        ...
        for i = 2:length(reduced_filter)
            VV0, EV0, FV0 =
                AlphaStructures.alphaSimplex(Vi, filtration, reduced_filter[i-1])
